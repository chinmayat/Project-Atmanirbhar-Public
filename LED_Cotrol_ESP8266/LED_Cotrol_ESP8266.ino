...
#define TEMBOO_ACCOUNT "ChXXXXXXX"  // Your Temboo account name 
#define TEMBOO_APP_KEY_NAME "FiXXXX"  // Your Temboo app key name
...
void callsms() 
{
    ...
    SendSMSChoreo.setAccountName("ChXXXXXX");
    SendSMSChoreo.setAppKeyName("XXXXX");
    SendSMSChoreo.setAppKey("ZXXXXXXXXXXXXXXXXXXXXXXXXXN"); 
    // Set Choreo inputs
    String AuthTokenValue = "fxxxxxxxxxxxxxxxxxxxxx62";
    SendSMSChoreo.addInput("AuthToken", AuthTokenValue);
    String ToValue = "+9198XXXXXX32";
    SendSMSChoreo.addInput("To", ToValue);
    String FromValue = "+18XXXXXXX0";
    SendSMSChoreo.addInput("From", FromValue);
    String BodyValue = "From PROJECT ATMANIRBHAR : Light is off";
    SendSMSChoreo.addInput("Body", BodyValue);
    String AccountSIDValue = "ACXXXXXXXXXXXXXXXXXXXXXX2";
